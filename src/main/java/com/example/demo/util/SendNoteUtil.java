...
public class SendNoteUtil {
    ...
    DefaultProfile profile = DefaultProfile.getProfile("default", "LTAI4GFcoD1SQDfnpTUCBSUW", "pU3MD62ZuVmkhHCFiP0tuP7QJxAM9d");
    ...
    public String sendNoteMessgae(String PhoneNumbers,String template){
        ...
        request.putQueryParameter("SignName", "oocoming");//签名
        //模板代码,我暂时用的参数,你可以直接写成模板码,模板码参考第八步
        request.putQueryParameter("TemplateCode", "SMS_191485401");
        //用户定义的验证码内容
